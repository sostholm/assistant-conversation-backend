...
from .memory_assistant import memory_tool
from ..tools.home_assistant_tools import send_message_to_conversation, ask_home_assistant
...
tools = [TavilySearchResults(max_results=5), memory_tool, ask_home_assistant]
